...
function ProjectCard({ project }) {
  ...
  const status = {
    live: {
      label: t('projects.statusLive'),
      bg: 'bg-emerald-100',
      text: 'text-emerald-700',
      dot: 'bg-emerald-500',
    },
    offline: {
      label: t('projects.statusLocal'),
      bg: 'bg-slate-100',
      text: 'text-slate-500',
      dot: 'bg-slate-400',
    },
        ...
        <div className="flex items-center gap-4 pt-3 border-t border-slate-100 mt-auto">
          {project.url && (
            ...
            >
              ...
              <span>{t('projects.cardVisit')}</span>
            </a>
          )}
          {project.repo && (
            <a
            ...
            >
              <GithubIcon size={13} />
              <span>{t('projects.cardSource')}</span>
            </a>
          )}
        </div>
      </div>
...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      badge: t('projects.norahrBadge'),
    },
    {
      title: 'Sharks Launchpad',
      desc: t('projects.sharksDesc'),
      ...
      badge: t('projects.sharksBadge'),
    },
    {
      title: 'Event Pro Jinaite',
      desc: t('projects.eventproDesc'),
    ...
    },
    {
      ...
      desc: t('projects.miniStudioDesc'),
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mt-3">
            {t('projects.sectionHeadingPrefix')} <span className="gradient-text">{t('projects.sectionHeadingGradient')}</span>
          </h2>
        ...
        >
          <span className="inline-flex items-center gap-1.5">
            ...
            {t('projects.legendLive')}
          </span>
          <span className="inline-flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-slate-400" />
            {t('projects.legendLocal')}
          </span>
        </motion.div>
      </div>
    </section>
