  ...
  const experiences = [
    {
      ...
      bullets: [
        t('experience.job0.bullets.0'),
        t('experience.job0.bullets.1'),
        t('experience.job0.bullets.2'),
        t('experience.job0.bullets.3'),
      ],
    ...
    },
    {
      ...
      bullets: [
        t('experience.job1.bullets.0'),
        t('experience.job1.bullets.1'),
        t('experience.job1.bullets.2'),
        t('experience.job1.bullets.3'),
      ],
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
            {t('experience.sectionHeadingPrefix')}{' '}
            <span className="gradient-text">{t('experience.sectionHeadingGradient')}</span>
          </h2>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
          ...
          >
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">{t('experience.snapshotLabel')}</p>
                <h3 className="mt-2 text-xl font-semibold text-white">{t('experience.snapshotTitle')}</h3>
              </div>
            ...
            <div className="mt-6 rounded-3xl border border-white/10 bg-navy-900/70 p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">{t('experience.workingStyleLabel')}</p>
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                {t('experience.workingStyleText')}
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">{t('experience.focusLabel')}</p>
                <h3 className="mt-2 text-xl font-semibold text-white">{t('experience.focusTitle')}</h3>
              </div>
            ...
            <div className="mt-5 space-y-3">
              {t('experience.focusPoints').map((point) => (
            ...
            <div className="mt-6 rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">{t('experience.outcomeLabel')}</p>
              <h4 className="mt-2 text-lg font-semibold text-white">{t('experience.outcomeTitle')}</h4>
              <p className="mt-2 text-sm leading-relaxed text-slate-300">
                {t('experience.outcomeDescription')}
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-10">
          ...
          >
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">{t('experience.timelineLabel')}</p>
              <h3 className="mt-2 text-2xl font-semibold text-white">{t('experience.timelineTitle')}</h3>
            </div>
            <p className="hidden sm:block max-w-md text-right text-sm text-slate-400">
              {t('experience.timelineDescription')}
            </p>
          </motion.div>
